                      ...
                      <div class="well">
                          <form id="loginForm" method="post">
                              <div class="form-group">
                                  <label for="username" class="control-label">Gebruikernaam</label>
                                  <input type="text" class="form-control" id="username" name="username"  required="" title="Vul hier je gebruikersnaam in!" placeholder="Vul hier je gebruikersnaam in!" >
                                  <span class="help-block"></span>
                              </div>
                              <div class="form-group">
                                  <label for="password" class="control-label">Wachtwoord</label>
                                  <input type="password" class="form-control" id="password" name="password" placeholder="Vul hier je wachtwoord in!" value="" required="" title="Vul hier je wachtwoord in!">
                                  <span class="help-block"></span>
                              </div>
                           
                              <button type="submit" class="btn btn-success btn-block" name="login">Inloggen</button>
                          </form>
                      </div>
                  </div>
                  <div class="col-xs-6">
                      ...
                      <ul class="list-unstyled" style="line-height: 2">
                          <li><span class="fa fa-check text-success"></span> Dit loginpaneel is bedoeld voor medewerkers van V!ST@CARS. </li>
                          <img src="../images/logo.png"  width="200" height="175">`
                          <br>
                          <a href="../homepage.php">Klik hier om naar de website te gaan.</a>
                      </ul>
