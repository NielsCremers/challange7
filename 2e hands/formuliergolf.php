...
<htmls lang="en" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="2dehands.css" />
    ...
    <body>
        ...
        <ul>
            ...
            <li><a href="https://vistacollege.nl/nieuws/corona"><i class="fas fa-hands-wash"></i>Covid 19</a></li>
                ...
                <div class="contact-form">
                    ...
                    <form action="homepage.php">
                      ...
                      <h1 style="color:white"> Naam: </h1>  
                        ...
                        <div class="input-container">
                        <h1 style="color:white"> Telefoonnummer: </h1>  
                            <input type="tel" name="phone" class="input">
                        </div>
                        <div class="input-container textarea">
                        <h1 style="color:white"> Bericht </h1>  
                            <textarea name="message" class="input"></textarea>
                           
                        </div>
                        <div class="input-container textarea">
                        <h1 style="color:white"> De door u geselecteerde auto: Volkswagen Golf 1.4-16V Trendline</h1>
                        </div>
